...
@php
    ...
    $classes = 'flex-shrink-0 flex items-center gap-2 p-2 transition-colors rounded-md ' . $isActiveClasses;
...
@if ($collapsible)
    <button type="button" {{ $attributes->merge(['class' => $classes]) }}>
        ...
        <span x-show="isSidebarOpen || isSidebarHovered" aria-hidden="false" class="relative block ml-auto w-6 h-6">

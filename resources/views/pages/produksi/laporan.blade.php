            ...
            <table class="table text-center border border-white ">
                <thead class="thead-dark bg-white">
                    <tr class="border border-white text-black">
                        ...
                        <th class="border border-white" scope="col">Total Operasional</th>
                        <th class="border border-white" scope="col">Total Pemasukan</th>
                        <th class="border border-white" scope="col">Total Pengeluaran</th>
                ...
                <tbody>
                    @foreach ($data as $key => $item)
                        <tr class="border border-white">
                            ...
                            <td class="border border-white">{{ $countOp }}</td>
                            <td class="border border-white">{{ $countPem }}</td>
                            <td class="border border-white">{{ $countPeng }}</td>

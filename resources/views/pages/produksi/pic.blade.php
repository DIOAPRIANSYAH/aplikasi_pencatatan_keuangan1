<x-app-layout>
    ...
    <div class="flex flex-col mb-2 gap-4 md:flex-row md:items-end md:justify-end">
            ...
            <table class="table text-center border border-white ">
                <thead class="thead-dark bg-white">
                    <tr class="border border-white text-black">
                        ...
                        <th class="border border-white" scope="col">Kode Pegawai</th>
                        <th class="border border-white" scope="col">Nama Lengkap</th>
                        <th class="border border-white" scope="col">Divisi</th>
                        <th class="border border-white" scope="col">Jabatan</th>
                        <th class="border border-white" scope="col">Email</th>
                        <th class="border border-white" scope="col">Join at</th>
                ...
                <tbody>
                    @foreach ($pic as $key => $item)
                        <tr class="border border-white">
                            ...
                            <td class="border border-white">{{ $item->kode_peg }}</td>
                            <td class="border border-white">{{ $item->nama }}</td>
                            <td class="border border-white">{{ $item->divisi }}</td>
                            <td class="border border-white">{{ $item->jabatan }}</td>
                            <td class="border border-white">{{ $item->email }}</td>
